...
void ETCCalibrate(void) {
    ...
    uiTPS1min = uiTPS1 - 50;
    uiTPS2min = uiTPS2 + 50;
    uiTPS1TableIn[0]= uiTPS1 - 50;
    uiTPS2TableIn[0]= uiTPS2 + 50;
    __nop();


    GPIO_PWM2_Control(100, 600);

    _delay((unsigned long)((700)*(10000000/4000.0)));
    ...
    uiTPS1max = uiTPS1 - 50;
    uiTPS2max = uiTPS2 + 50;
    uiTPS1TableIn[21 -1]= uiTPS1 - 50;
    uiTPS2TableIn[21 -1]= uiTPS2 + 50;
    __nop();
...
{
# 333 "ETC.c"
    ucTPS1Perc = ETCPercentMultiCalcTPS1 (uiTPS1, uiTPS1TableIn, ucTPS1TableOut, 21);
    ucTPS2Perc = ETCPercentMultiCalcTPS2 (uiTPS2, uiTPS2TableIn, ucTPS2TableOut, 21);
    ucTPS = ( ( ucTPS1Perc + ucTPS2Perc ) / 2 );
    __nop();



    if ( ( ulTPS1calc > uiTPS1 + 50 ) || ( ulTPS1calc < uiTPS1 - 50 ) )
    {
    ...
    if ( ( ulTPS2calc > uiTPS2 + 50 ) || ( ulTPS2calc < uiTPS2 - 50 ) )
    {
