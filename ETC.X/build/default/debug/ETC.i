...
void ETCRulesSensorsSupervision(void)
{
    if ( 1 == 1 )
    {
        ...
        if (ucTPS1Perc > (ucTPS2Perc+19))
        {
            ucETCTimerRuleTPS = 0x00;
        }
        else if (ucTPS2Perc > (ucTPS1Perc+19))
        {
            ucETCTimerRuleTPS = 0x00;
        }
        else
        ...
        if ( ((ucAPPS1Perc - ucAPPS2Perc) > 30) || ((ucAPPS2Perc - ucAPPS1Perc) > 30) ) {
...
void ETCRulesMotorSupervisor (unsigned char ucTPStarget, unsigned char ucTPSactual)
{
    ...
    if ( 1 == 1 )
    {
        if (ucTPStarget>ucTPSactual+19)
        {
            ucETCTargetTPSDiff = 0x00;
        }
        else if (ucTPSactual>ucTPStarget+19)
        {
            ucETCTargetTPSDiff = 0x00;
        }
        else
