    ...
    if ( ucETCFlagSupervisor == 0x01 )
    {
        ...
        if ( ucMode == ucASMode )
        {
            if ( ucMode == 1 )
            {
                ...
                GPIO_PWM2_Control(uiETCDuty + 10, 600);
            }
            else
            {
...
void TPSAnalysis (void)
{
    ...
    if ( ( ucTPS1calc > ucTPS1 + 20 ) || ( ucTPS1calc < ucTPS1 - 20 ) )
    {
    ...
    if ( ( ucTPS2calc > ucTPS2 + 20 ) || ( ucTPS2calc < ucTPS2 - 20 ) )
    {
